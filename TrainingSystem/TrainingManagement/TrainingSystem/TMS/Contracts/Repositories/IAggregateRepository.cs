...
namespace TMS
{
    public interface IAggregateRepository
    {
        ...
        Task<List<PersonInfoForCoach>> GetFreeAthletesByDayAggregate(string date, string coachId);
        Task<List<PersonInfoForCoach>> GetAllCoachAthletesAggregate(string coachId);
